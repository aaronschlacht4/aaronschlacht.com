/**
 * The physica.fyi renderer, verbatim: one GLSL ES 3.0 fragment shader that
 * traces every pixel backwards along a Schwarzschild null geodesic.
 * Source: https://github.com/aaronschlacht4/physica (MIT) — src/shader.ts.
 * Kept byte-for-byte so the window here is the real thing, not a sketch of it.
 */
